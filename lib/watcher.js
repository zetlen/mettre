...
/**
 * @typedef FoundTorrent
 * @property {("magnet","torrent")} type - magnet or torrent
 * @property {(Buffer,string)} contents - raw file contents
 * @property {string} cwd - directory where found
 * @property {Object} data - parsed torrent data
 * @property {string} filename - filename
 * @property {import('node:fs').Stats} stats - file stats
 */
...
export class Watcher extends EventEmitter {
	...
	async #handleFileAdded(baseName, stats) {
		...
		/** @type {FoundTorrent} */
		const dropped = { type, contents, cwd, data, filename, stats };
